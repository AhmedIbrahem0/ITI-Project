        ...
        <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
            <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
                ...
                <div class="flex items-center lg:justify-center text-sm mt-4">
                    <img src="{{asset('/storage/images').'/' . $post->author->avatar}}" width="50" alt="Lary avatar">
            ...
            <form action="/posts/{{$post->id}}" method="post">
                @csrf
                @method("DELETE")
                <input type="submit" class="btn " style="background-color: red; color: white" value="Delete">
            </form>
                    <br><a href="/posts/{{$post['id']}}/edit" class="btn btn-success">Edit</a>
         ...
         {{--        Adding comment--}}
        <form action="/addingComment" method="get">
            @csrf
            <div class="coment-bottom bg-white p-2 px-4">
                <div class="d-flex flex-row add-comment-section mt-4 mb-4">
                    <input type="text" class="form-control mr-3" name='body' placeholder="Add comment">
                    <input type="text" class="form-control mr-3 visually-hidden" name="id" value="{{$post->id}}" >
